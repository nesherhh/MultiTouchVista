...
namespace Multitouch.Contracts.AddInSideAdapters
{
    ...
    public class IProviderViewToContractAddInAdapter : System.AddIn.Pipeline.ContractBase, Multitouch.Contracts.Contracts.IProviderContract
    {
        ...
        {
            System.EventHandler<Multitouch.Contracts.ContactChangedEventArgs> adaptedHandler = new System.EventHandler<Multitouch.Contracts.ContactChangedEventArgs>(new Multitouch.Contracts.AddInSideAdapters.IContactChangedEventHandlerContractToViewAddInAdapter(handler).Handler);
